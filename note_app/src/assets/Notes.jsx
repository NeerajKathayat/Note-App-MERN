...
const Notes = () => {
    ...
    const fetchNotes = async()=>{
        let getNote = await fetch("https://note-backend-eight.vercel.app/get-note",{
            method:'GET',
            headers:{
    ...
    const handleDelete = async (note) => {
        let deleteNote = await fetch(`https://note-backend-eight.vercel.app/${note._id}`,{
            method:'DELETE',
                headers:{
                   'Content-Type':'application/json'
                },
    ...
    const handlePinned = async (note)=>{
          ...
          let result = await fetch(`https://note-backend-eight.vercel.app/updated-note-pinned/${note._id}`,{
            method:'PUT',
            headers:{
                'Content-Type':'application/json'
             },
