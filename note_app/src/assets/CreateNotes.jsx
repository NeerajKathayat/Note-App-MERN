...
const CreateNotes = ({setModal,notes,setNotes,currentNote,setCurrentNote,setNoteAlert,setNoteMessage,setAlertType}) => {
    ...
    const HandleSubmit = async () =>{
        ...
        if(currentNote){
            ...
            let updatedNote = await fetch(`https://note-app-mern-six.vercel.app/edit-note/${currentNote._id}`,{
                method:'PUT',
                headers:{
            ...
            let newNote = await fetch("https://note-app-mern-six.vercel.app/add-note",{
                method:'POST',
                headers:{
                   'Content-Type':'application/json'
                },
